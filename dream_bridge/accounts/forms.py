...
# class CustomUserCreationForm(UserCreationForm):
#     # champs supplémentaires (pas encore enregistrés en base)
...
#     class Meta(UserCreationForm.Meta):
#         model = User
#         # password1/password2 sont des champs de formulaire (pas du modèle) – ok.
#         fields = ("username", "email", "password1", "password2", "birth_date", "believes_in_astrology")

#     def __init__(self, *args, **kwargs):
#         super().__init__(*args, **kwargs)

#         # Nettoyer les help_text
#         self.fields['password1'].help_text = None
#         self.fields['password2'].help_text = None

#         # Styles/cohérence avec ton UI
#         self.fields['username'].widget.attrs.update(
#             {'class': 'form-control', 'placeholder': "Nom d'utilisateur"}
#         )
#         self.fields['email'].widget.attrs.update(
...
#             {'class': 'form-control'}
#         )
#         # Checkbox → style bootstrap
#         self.fields['believes_in_astrology'].widget.attrs.update(
